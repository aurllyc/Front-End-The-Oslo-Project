import { Ft as onMounted, Gn as readonly, Kn as ref, Ot as nextTick, Wn as reactive, gn as watch, ut as getCurrentInstance, xt as inject } from "./vue.runtime.esm-bundler-CJPQuahF.js";
...
var BaseStyle = {
	...
	load: function load(style) {
		...
		return s$1(computedStyle) ? useStyle(Y$1(computedStyle), _objectSpread$1({ name: this.name }, options)) : {};
	},
